      ...
      <div className="flex items-center gap-3">
        <div className="relative hidden md:block">
          ...
          <input
            ...
            className="bg-slate-800 border border-slate-700 text-sm text-white placeholder:text-slate-500 rounded-xl pl-9 pr-4 py-2 w-56 focus:outline-none focus:border-primary-500 transition-colors"
          />
        </div>
        {action && (
        ...
        <Link to="/settings" className="flex items-center gap-2 pl-2 border-l border-slate-800">
